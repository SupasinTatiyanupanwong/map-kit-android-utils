...
import me.tatiyanupanwong.supasin.android.libraries.kits.maps.utils.heatmaps.Gradient;
import me.tatiyanupanwong.supasin.android.libraries.kits.maps.utils.heatmaps.HeatmapTileProvider;
...
public class HeatmapsDemoActivity extends BaseDemoActivity {
        ...
        if (!isRestore) {
            getMap().moveCamera(
                    MapKit.getCameraUpdateFactory()
                            .newLatLngZoom(MapKit.newLatLng(-25, 143), 4)
            );
        }
    ...
    public class SpinnerActivity implements AdapterView.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (mProvider == null) {
                ...
                mOverlay = getMap().addTileOverlay(
                        MapKit.newTileOverlayOptions()
    ...
    private ArrayList<LatLng> readItems(int resource) throws JSONException {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            list.add(MapKit.newLatLng(lat, lng));
        }
        return list;
    }
