...
import dev.supasintatiyanupanwong.libraries.android.kits.maps.utils.data.Point;
...
public class GeoJsonPoint extends Point {
    ...
    /**
     * A class that allows for GeoJsonPoint objects to be styled and for these styles to be
     * translated into a MarkerOptions object.
     */
    public static class Style extends
            dev.supasintatiyanupanwong.libraries.android.kits.maps.utils.data.Style implements
            GeoJsonStyle {
        ...
        /**
         * Gets the alpha of the GeoJsonPoint. This is a value from 0 to 1, where 0 means the
        ...
        /**
         * Sets the alpha of the GeoJsonPoint. This is a value from 0 to 1, where 0 means the
         * marker is completely transparent and 1 means the marker is completely opaque.
         *
        ...
        /**
         * Gets the Anchor U coordinate of the GeoJsonPoint. Normalized to [0, 1], of the anchor
         * from the left edge. This is equivalent to the same U value used in {@link
        ...
        /**
         * Gets the Anchor V coordinate of the GeoJsonPoint. Normalized to [0, 1], of the anchor
         * from the top edge. This is equivalent to the same V value used in {@link
        ...
        /**
         * Sets the Anchor U and V coordinates of the GeoJsonPoint. The anchor point is specified
         * in the continuous space [0.0, 1.0] x [0.0, 1.0], where (0, 0) is the top-left corner of
         * the image, and (1, 1) is the bottom-right corner. The U &amp; V values are the same U
         * &amp; V values used in {@link Marker.Options#anchor(float, float)}.
         *
         ...
         *
         * @param draggable {@code true} if GeoJsonPoint is draggable, {@code false} if not
         * draggable
         */
        ...
        /**
         * Gets the info window anchor U coordinate of the GeoJsonPoint. Normalized to [0, 1], of
         * the info window anchor from the left edge. This is equivalent to the same U value used
         * in {@link Marker.Options#getInfoWindowAnchorU()}.
         *
        ...
        /**
         * Gets the info window anchor V coordinate of the GeoJsonPoint. Normalized to [0, 1], of
         * the info window anchor from the top edge. This is equivalent to the same V value used
         * in {@link Marker.Options#getInfoWindowAnchorV()}.
         *
        ...
        /**
         * Sets the info window anchor U and V coordinates of the GeoJsonPoint. This is specified
         * in the same coordinate system as the anchor. The U &amp; V values are the same U &amp; V
         * values used in {@link Marker.Options(float, float)}.
         *
        ...
        /**
         * Gets the rotation of the GeoJsonPoint in degrees clockwise about the marker's anchor
         * point
         *
        ...
        /**
         * Sets the rotation of the GeoJsonPoint in degrees clockwise about the marker's anchor
         * point
         *
